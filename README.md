...
`Dida\Http` 对项目中使用到的Http的相关部分进行了包装。它是 [宙品科技](http://zeupin.com) 开源的 [Dida框架](http://dida.zeupin.com) 的一个功能组件库。

* Home <https://github.com/zeupin/dida-http>
* Wiki <https://github.com/zeupin/dida-http/wiki>
